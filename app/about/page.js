...
function About() {
  return (
    ...
    <section class="mb-32 text-gray-800 background-radial-gradient">
      ...
      <div class="px-6 pt-10 md:px-12 text-center lg:text-left">
        <div class="container mx-auto">
          <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div class="mt-12 lg:mt-0">
              ...
              <p class="text-lg">
              Our company name was inspired by the Roman god Vulcan. If you are unfamiliar with the name maybe its Greek counterpart will jog your memory which is Hephaestus the greek and roman god of fire and forge. We rely heavily on our equipment, tools, and stable temperatures so who better to ask for good fortune than naming it after Vulcan. The block is also short for blockchain resulting in “Vulcan Block Miners”. Our goal is to mine cryptocurrency efficiently and profitably, providing us with an endless source of passive income to grow and expand into future endeavors such as real estate, lending, and establishing our very own cryptocurrency.
              </p>  
            </div>
            <div class="mb-12 lg:mb-0">
              <div class="embed-responsive embed-responsive-16by9 relative w-full overflow-hidden rounded-lg shadow-lg">
                <img src="https://images.unsplash.com/photo-1642239817356-9dffb1bcc156?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2832&q=80"></img>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="2xl:container 2xl:mx-auto lg:py- lg:px-20 md:py-10 md:px-6 px-4">
